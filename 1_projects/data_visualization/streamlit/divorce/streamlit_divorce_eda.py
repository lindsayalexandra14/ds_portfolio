...
columns_to_clean = ['age_diff', 'inc_man', 'inc_woman']

outlier_flags = pd.DataFrame(False, index=df.index, columns=columns_to_clean)
...
with st.expander("Data Overview"):
    ...
    "It was sourced from the DataCamp repository.<br><br>"
    ...
    "income_man & income_woman: monthly income<br>"
...
"for each features, which is acceptable and does not warrant removal of any variables.")